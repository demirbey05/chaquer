...
function CastleAttackModal() {
    const { setMyArmyConfig, setEnemyArmyConfig, myArmyConfig, enemyArmyConfig, setIsAttackStage, attackFromArmyPosition, setAttackToArmyPosition, setAttackFromArmyPosition } = useTerrain();
    const attackFromArmyId = useRef<EntityID>("0" as EntityID);
    const attackToCastleId = useRef<EntityID>("0" as EntityID);
