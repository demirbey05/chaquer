...
function Menu() {
    ...
    return (
        <div style={{backgroundImage:`url(${dungeonImg})`, backgroundSize:"cover", backgroundRepeat:"no-repeat"}}>
                ...
                <div className="row align-items-center justify-content-center h-screen items-center">
                    {
                        ...
                        {refresh === 0 ? null : (
                            <div className="col-8 align-items-center justify-content-center">
                            <Grid width={width} height={height} values={values} pixelStyles={terrainStyles} isBorder={true}/>
                            </div>
                        )}
                        </>
                    }
                    <div className="col align-items-center justify-content-center">
                        ...
                        <img className="m-auto mb-5" src={castleImg} style={{width:"250px",height:"250px", justifyContent:"center"}}></img>
                        {refresh !== 0 &&
